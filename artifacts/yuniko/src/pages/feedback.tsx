    ...
    <div className="w-full max-w-[430px] mx-auto min-h-screen bg-background pb-20">
      ...
      <div className="px-4 py-5 flex flex-col gap-5">
          ...
          <div className="flex flex-wrap gap-2">
            {CATEGORIES.map((cat) => (
              <button
                ...
                style={{
                  background: category === cat ? "linear-gradient(135deg, #7C3AED, #4F46E5)" : "rgba(255,255,255,0.07)",
        ...
        <button
          ...
          style={{
            background: message.trim() ? "linear-gradient(135deg, #7C3AED, #4F46E5)" : "rgba(255,255,255,0.08)",
            opacity: message.trim() ? 1 : 0.5,
            boxShadow: message.trim() ? "0 4px 20px rgba(124,58,237,0.4)" : "none",
          }}
